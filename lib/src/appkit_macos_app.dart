...
/// scrolling physics.
///
/// The [AppKitMacosApp] configures the top-level [Navigator] to search for routes
...
class AppKitMacosApp extends c.StatefulWidget {
  /// Creates a MacosApp.
  ///
  ...
  final AppKitThemeData? darkTheme;

  /// The style used if [themeMode] is [ThemeMode.light]
  final AppKitThemeData? theme;

  @override
  State<AppKitMacosApp> createState() => _AppKitMacosAppState();
}
...
/// Describes how [Scrollable] widgets behave for [AppKitMacosApp]s.
///
