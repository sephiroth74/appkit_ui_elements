...
class AppKitDateTimePickerTheme extends InheritedTheme {
  ...
  const AppKitDateTimePickerTheme({super.key, required super.child, required this.data});
  ...
  static AppKitDateTimePickerThemeData of(BuildContext context) {
    final AppKitDateTimePickerTheme? dateTimePickerTheme = context
        .dependOnInheritedWidgetOfExactType<AppKitDateTimePickerTheme>();
    return dateTimePickerTheme?.data ?? AppKitTheme.of(context).dateTimePickerTheme;
  }
}
...
class AppKitDateTimePickerThemeData with Diagnosticable {
  ...
  AppKitDateTimePickerThemeData copyWith({
    ...
    return AppKitDateTimePickerThemeData(
      graphicalDatePickerBackgroundColor: graphicalDatePickerBackgroundColor ?? this.graphicalDatePickerBackgroundColor,
      textualDatePickerBackgroundColor: textualDatePickerBackgroundColor ?? this.textualDatePickerBackgroundColor,
  ...
  AppKitDateTimePickerThemeData merge(AppKitDateTimePickerThemeData? other) {
    ...
    return copyWith(
      graphicalDatePickerBackgroundColor: other.graphicalDatePickerBackgroundColor,
      textualDatePickerBackgroundColor: other.textualDatePickerBackgroundColor,
      accentColor: other.accentColor,
    );
  }

  static AppKitDateTimePickerThemeData lerp(
    AppKitDateTimePickerThemeData? a,
    AppKitDateTimePickerThemeData? b,
    double t,
  ) {
    return AppKitDateTimePickerThemeData(
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(ColorProperty('graphicalDatePickerBackgroundColor', graphicalDatePickerBackgroundColor));
    properties.add(ColorProperty('textualDatePickerBackgroundColor', textualDatePickerBackgroundColor));
