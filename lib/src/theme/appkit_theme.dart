...
class AppKitTheme extends StatelessWidget {
  ...
  const AppKitTheme({super.key, required this.data, required this.child});
  ...
  Widget build(BuildContext context) {
    return _InheritedAppKitTheme(theme: this, child: child);
  }
...
class _InheritedAppKitTheme extends InheritedWidget {
  const _InheritedAppKitTheme({required this.theme, required super.child});
...
class AppKitThemeData extends Equatable with Diagnosticable {
  ...
  factory AppKitThemeData({
    ...
    activeColor ??= _ColorProvider.getPrimaryColor(accentColor: accentColor, isDark: isDark, isMainWindow: true);
    ...
    keyboardFocusIndicatorColor ??= _ColorProvider.getKeyboardFocusIndicatorColor(
      isDark: isDark,
      accentColor: accentColor,
    );

    selectedTextBackgroundColor ??= _ColorProvider.getSelectedTextBackgroundColor(
      isDark: isDark,
      accentColor: accentColor,
    );

    selectedControlColor ??= _ColorProvider.getSelectedControlColor(isDark: isDark, accentColor: accentColor);

    selectedContentBackgroundColor ??= _ColorProvider.getSelectedContentBackgroundColor(
      accentColor: accentColor,
      isDark: isDark,
      isMainWindow: true,
    );
    selectedContentBackgroundColorUnfocused ??= _ColorProvider.getSelectedContentBackgroundColor(
      accentColor: accentColor,
      isDark: isDark,
      isMainWindow: false,
    );
    ...
    isMainWindow ??= true;
    canvasColor ??= isDark ? AppKitColors.canvasColor.darkColor : AppKitColors.canvasColor.color;
    ...
    controlColor ??= isDark ? AppKitColors.controlColor.darkColor : AppKitColors.controlColor.color;

    Color controlBackgroundColorDisabledDark = AppKitColors.controlBackgroundColor.darkColor.withValues(alpha: 0.35);
    Color controlBackgroundColorDisabledLight = AppKitColors.controlBackgroundColor.color.withValues(alpha: 0.35);
    ...
    dividerColor ??= isDark ? AppKitColors.separatorColor.darkColor : AppKitColors.separatorColor.color;

    buttonTheme ??= AppKitButtonThemeData(
      inline: AppKitInlineButtonThemeData(
        secondaryColor: controlColor,
        destructiveColor: isDark ? AppKitColors.systemRed.darkColor : AppKitColors.systemRed.color,
        accentColor: activeColor,
        backgroundColorDisabled: isDark ? controlColor.multiplyOpacity(0.5) : controlColor.multiplyOpacity(0.5),
      ),
      ...
      push: AppKitPushButtonThemeData(
        ...
        backgroundColorDisabled: isDark ? controlColor.multiplyOpacity(0.75) : controlColor.multiplyOpacity(0.75),
      ),
    );

    sliderTheme ??= AppKitSliderThemeData(
      trackColor: isDark ? AppKitColors.controlColor.darkColor : const Color(0xFFe1e0de),
      thumbColor: AppKitColors.controlColor.color,
      sliderColor: activeColor,
      tickColor: isDark ? const Color.fromARGB(255, 155, 155, 155) : const Color(0xFFC9C9C7),
    ...
    circularSliderTheme ??= AppKitCircularSliderThemeData(
      backgroundColor: isDark ? AppKitColors.controlColor.darkColor : AppKitColors.controlColor.color,
      thumbColor: isDark ? Colors.black.withValues(alpha: 0.75) : Colors.black.withValues(alpha: 0.5),
      thumbColorUnfocused: activeColorUnfocused,
    );

    segmentedControlTheme ??= AppKitSegmentedControlThemeData(
      accentColor: selectedContentBackgroundColor,
      dividerColorMultipleSelection: isDark ? AppKitColors.separatorColor.darkColor : const Color(0xFFE8E8E8),
      dividerColorSingleSelection: isDark ? AppKitColors.separatorColor.darkColor : const Color(0xFFCCCBCB),
      singleSelectionColor: isDark ? AppKitColors.materials.ultraThin.elevatedColor : AppKitColors.controlColor.color,
    );

    switchTheme ??= AppKitSwitchThemeData(
      checkedColor: activeColor,
      uncheckedColor: isDark ? const Color(0xFF414141) : const Color.fromRGBO(200, 200, 200, 1.0),
      uncheckedColorDisabled: isDark ? const Color(0x7F414141) : const Color.fromRGBO(200, 200, 200, 0.5),
    );
    ...
    tooltipTheme ??= AppKitTooltipThemeData(
      verticalOffset: 18.0,
      padding: const EdgeInsets.only(left: 6.0, top: 3.0, right: 6.0, bottom: 5.0),
      ...
      textStyle: typography.callout.copyWith(
        fontSize: 13.0,
        color: isDark ? AppKitColors.text.opaque.secondary.darkColor : const Color(0xFF4D4D4D),
      ),
      decoration: () {
        ...
        final border = Border.all(
          width: 0.5,
          color: isDark ? const Color.fromRGBO(144, 144, 144, 1.0) : const Color(0xFF4D4D4D),
        );

        return BoxDecoration(
          color: isDark ? AppKitColors.unemphasizedSelectedTextBackgroundColor.darkColor : const Color(0xFFF6F6F6),
          borderRadius: radius,
          boxShadow: shadow,
          border: border,
        );
    ...
    comboButtonTheme ??= AppKitComboButtonThemeData.fallback(brightness: brightness, typography: typography);

    contextMenuTheme ??= AppKitContextMenuThemeData(
      backgroundBlur: 2,
      borderRadius: 6.0,
      backgroundColor: isDark ? AppKitColors.controlBackgroundColor.darkColor : const Color(0xFFe7e7e7),
    );

    iconTheme ??= AppKitIconThemeData(color: activeColor, size: 20);

    scrollbarTheme ??= AppKitScrollbarThemeData(
      thickness: 6.0,
      thicknessWhileHovering: 9.0,
      thumbColor: isDark ? AppKitColors.scrollbarColor.darkColor : AppKitColors.scrollbarColor.color,
    ...
    dateTimePickerTheme ??= AppKitDateTimePickerThemeData(
      graphicalDatePickerBackgroundColor:
          (isDark ? AppKitColors.controlColor.darkColor : AppKitColors.controlColor.color).multiplyOpacity(0.5),
      textualDatePickerBackgroundColor: (isDark ? AppKitColors.controlColor.darkColor : AppKitColors.controlColor.color)
          .multiplyOpacity(0.5),
      accentColor: activeColor,
    );
    ...
    final defaultData = AppKitThemeData.raw(
      ...
      selectedContentBackgroundColorUnfocused: selectedContentBackgroundColorUnfocused,
  ...
  factory AppKitThemeData.light({AppKitAccentColor? accentColor, bool isMainWindow = true}) =>
      AppKitThemeData(brightness: Brightness.light, accentColor: accentColor, isMainWindow: isMainWindow);

  factory AppKitThemeData.dark({AppKitAccentColor? accentColor, bool isMainWindow = true}) =>
      AppKitThemeData(brightness: Brightness.dark, accentColor: accentColor, isMainWindow: isMainWindow);

  factory AppKitThemeData.fallback() =>
      AppKitThemeData.light().copyWith(visualDensity: VisualDensity.adaptivePlatformDensity);
  ...
  AppKitThemeData copyWith({
    ...
    return AppKitThemeData.raw(
      ...
      keyboardFocusIndicatorColor: keyboardFocusIndicatorColor ?? this.keyboardFocusIndicatorColor,
      ...
      selectedContentBackgroundColor: selectedContentBackgroundColor ?? this.selectedContentBackgroundColor,
      selectedContentBackgroundColorUnfocused:
          selectedContentBackgroundColorUnfocused ?? this.selectedContentBackgroundColorUnfocused,
  ...
  AppKitThemeData merge(AppKitThemeData? other) {
    ...
    return copyWith(
      ...
      selectedContentBackgroundColorUnfocused: other.selectedContentBackgroundColorUnfocused,
  ...
  AppKitThemeData lerp(AppKitThemeData a, AppKitThemeData b, double t) {
    return AppKitThemeData.raw(
      ...
      activeColorUnfocused: Color.lerp(a.activeColorUnfocused, b.activeColorUnfocused, t)!,
      ...
      controlBackgroundColor: Color.lerp(a.controlBackgroundColor, b.controlBackgroundColor, t)!,
      controlColor: Color.lerp(a.controlColor, b.controlColor, t)!,
      controlBackgroundPressedColor: Color.lerp(a.controlBackgroundPressedColor, b.controlBackgroundPressedColor, t)!,
      ...
      scrollbarTheme: AppKitScrollbarThemeData.lerp(a.scrollbarTheme, b.scrollbarTheme, t),
      dividerColor: Color.lerp(a.dividerColor, b.dividerColor, t)!,
      iconButtonTheme: AppKitIconButtonThemeData.lerp(a.iconButtonTheme, b.iconButtonTheme, t),
      keyboardFocusIndicatorColor: Color.lerp(a.keyboardFocusIndicatorColor, b.keyboardFocusIndicatorColor, t)!,
      selectedTextBackgroundColor: Color.lerp(a.selectedTextBackgroundColor, b.selectedTextBackgroundColor, t)!,
      selectedControlColor: Color.lerp(a.selectedControlColor, b.selectedControlColor, t)!,
      ...
      dateTimePickerTheme: AppKitDateTimePickerThemeData.lerp(a.dateTimePickerTheme, b.dateTimePickerTheme, t),
    );
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<AppKitButtonThemeData>('buttonTheme', buttonTheme));
    properties.add(DiagnosticsProperty<AppKitSliderThemeData>('sliderTheme', sliderTheme));
    properties.add(
      DiagnosticsProperty<AppKitSegmentedControlThemeData>('segmentedControlTheme', segmentedControlTheme),
    );
    ...
    properties.add(DiagnosticsProperty<AppKitIconThemeData>('iconTheme', iconTheme));
    properties.add(DiagnosticsProperty<AppKitScrollbarThemeData>('scrollbarTheme', scrollbarTheme));
    properties.add(ColorProperty('dividerColor', dividerColor));
    properties.add(DiagnosticsProperty<AppKitIconButtonThemeData>('iconButtonTheme', iconButtonTheme));
    properties.add(ColorProperty('keyboardFocusIndicatorColor', keyboardFocusIndicatorColor));
    properties.add(ColorProperty('selectedTextBackgroundColor', selectedTextBackgroundColor));
    properties.add(ColorProperty('selectedControlColor', selectedControlColor));
    properties.add(ColorProperty('selectedContentBackgroundColor', selectedContentBackgroundColor));
    properties.add(ColorProperty('selectedContentBackgroundColorUnfocused', selectedContentBackgroundColorUnfocused));
    properties.add(DiagnosticsProperty<AppKitDateTimePickerThemeData>('dateTimePickerTheme', dateTimePickerTheme));
  }
}
...
class _ColorProvider {
  ...
  static Color getPrimaryColor({
    ...
    if (!isMainWindow) {
      return isDark ? const Color.fromRGBO(100, 100, 100, 0.625) : const Color.fromRGBO(190, 190, 190, 1.0);
    }
  ...
  static Color getActiveColorUnfocused({required bool isDark}) {
    return isDark ? const Color.fromRGBO(76, 78, 65, 1.0) : const Color.fromRGBO(180, 180, 180, 1.0);
  }
  ...
  static Color getKeyboardFocusIndicatorColor({required AppKitAccentColor accentColor, required bool isDark}) {
    switch (accentColor) {
      case AppKitAccentColor.blue:
  ...
  static Color getSelectedTextBackgroundColor({required AppKitAccentColor accentColor, required bool isDark}) {
    switch (accentColor) {
      case AppKitAccentColor.blue:
  ...
  static Color getSelectedControlColor({required AppKitAccentColor accentColor, required bool isDark}) {
    switch (accentColor) {
      case AppKitAccentColor.blue:
        return !isDark ? const Color(0xFFB3D7FF) : const Color(0xFF3F638B);
      case AppKitAccentColor.purple:
