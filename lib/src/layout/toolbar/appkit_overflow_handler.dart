...
class AppKitOverflowHandler extends MultiChildRenderObjectWidget {
  ...
  @override
  AppKitRenderOverflowHandler createRenderObject(BuildContext context) {
    return AppKitRenderOverflowHandler(
      alignment: alignment,
...
class AppKitRenderOverflowHandler extends RenderBox
  ...
  void setupParentData(RenderBox child) {
    if (child.parentData is! AppKitOverflowHandlerParentData) {
      child.parentData = AppKitOverflowHandlerParentData();
    }
  }
  ...
  void performLayout() {
    ...
    if (lastChild != null) {
      final AppKitOverflowHandlerParentData overflowItemParentData =
          lastChild!.parentData! as AppKitOverflowHandlerParentData;
