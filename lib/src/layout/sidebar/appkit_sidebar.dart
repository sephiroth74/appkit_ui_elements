...
class AppKitSidebar {
  ...
  /// Specifies whether the [AppKitSidebar] can be resized by dragging or not.
  ...
  /// Specifies the width of the window at which this [AppKitSidebar] will be hidden.
  final double windowBreakpoint;

  /// Widget that should be displayed at the top of the [AppKitSidebar].
  ///
  /// Commonly a [MacosSearchField].
  final Widget? top;

  /// Widget that should be displayed at the bottom of the [AppKitSidebar].
  ///
